        ...
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <a href="#" class="text-sm rounded-md p-2 font-medium text-gray-100 hover:bg-gray-700 hover:text-white">Sign in</a></Link>
              <span class="h-6 w-px bg-gray-200" aria-hidden="true"></span><Link to={"signup"}>
              <a href="#" class="text-sm font-medium rounded-md p-2 text-gray-100 hover:bg-gray-700 hover:text-white">Create account</a></Link>
            </div>
                </div>
                </Menu.Button>
