      ...
      <>
        ...
        */}
        <div className="flex  min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          <div className="sm:mx-auto mt-8 sm:w-full sm:max-w-sm">
            <img
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" action="http://127.0.0.1:3000/post" method="POST">
              <div>
            ...
            <div class="flex items-center justify-center mt-4 dark:bg-gray-800">
